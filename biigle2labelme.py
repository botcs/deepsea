...
def convert_biigle_to_labelme(biigle_csv, output_directory):
    """
    Convert biigle annotation format to labelme format
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('biigle', type=str, help='Path to biigle CSV file')
    ...
    convert_biigle_to_labelme(biigle_csv, output_directory)
